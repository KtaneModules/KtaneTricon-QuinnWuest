...
public class IconFetch : MonoBehaviour
{
    ...
    private Coroutine _fetchRoutineRepo;

    private Coroutine _fetchRoutineIconSprite;
    ...
    private void Awake()
    {
        ...
        _fetchRoutineRepo = StartCoroutine(FetchRepo());
        _fetchRoutineIconSprite = StartCoroutine(FetchIconSprite());
    }
    ...
    private IEnumerator WaitForFetchRoutine(Action<bool> callback)
    {
        ...
        yield return _fetchRoutineRepo;
        yield return _fetchRoutineIconSprite;
